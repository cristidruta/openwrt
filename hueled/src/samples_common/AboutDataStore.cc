...
//extern void send_configMsg(char *json_buf, char *Manufacture, char *ManufactureSN);
extern "C" int parseDevPower(char *jsonBuf, char *power);
extern "C" int parseManufactureSN(char *jsonBuf,char *devSn);
using namespace ajn;
