...
class InterfaceDescription {
  ...
  public:
    ...
    QStatus SendCommandToDev(int socketFd, char *name, char *value, struct sockaddr *addr) const;
    QStatus GetDescriptionSocket(int *socketFd) const;
    QStatus GetDescriptionClientAddr(struct sockaddr *addr) const;
    QStatus GetDescriptionDevType(int *devType) const;
    QStatus SetDescriptionSocket(int socketFd);
    QStatus SetDescriptionClientAddr(struct sockaddr *addr);
    QStatus SetDescriptionDevType(int devType);
  ...
  private:
    ...
    int devType; /* 0-IP device 1-bluetooth 2-zigbee */
