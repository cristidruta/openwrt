...
start:
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    //ConfigService
    const char* objPath = "/config";

    configServiceListener = new ConfigServiceListenerImpl(*aboutDataStore, *msgBus, *busListener);
    configService = new ConfigService(*msgBus, *aboutDataStore, *configServiceListener, objPath);

    const char* ifaceName = "org.alljoyn.Config";
    status = configService->Register(ifaceName);
    if (status != ER_OK) {
